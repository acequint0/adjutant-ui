#!/usr/bin/env bash
# Install Adjutant UI 0.1 from GitHub on Kali / Debian / Ubuntu / Mint.
#
...
#
# System-wide:
#   curl -fsSL https://raw.githubusercontent.com/acequint0/adjutant-ui/v0.1.0/packaging/kali-install.sh | sudo bash -s -- --system
set -euo pipefail

REPO="${ADJUTANT_REPO:-https://github.com/acequint0/adjutant-ui.git}"
REF="${ADJUTANT_REF:-v0.1.0}"
...
echo
echo "Adjutant UI 0.1 is installed from $REPO ($REF)."
