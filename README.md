...
```bash
wget https://github.com/acequint0/adjutant-ui/releases/download/v0.2.3/adjutant-ui_0.2.3_all.deb
sudo apt-get install -y ./adjutant-ui_0.2.3_all.deb
```
...
sudo apt-get install -y ./dist/adjutant-ui_0.2.3_all.deb
```
